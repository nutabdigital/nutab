  ...
  return (
    <main id="main-content" role="main" tabIndex={-1} className="relative">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-24">
        <Link
          href="/portfolio"
          className="inline-flex items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-red-500 dark:hover:text-red-400 transition-colors duration-300"
        >
      ...
      <section className="relative min-h-[80vh] flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-8 pb-16">
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            A complete website transformation from a slow, outdated Squarespace site to a
            blazing-fast, modern Next.js application with perfect PageSpeed scores.
          </motion.p>
