...
export const generateMetadata = (): import("next").Metadata => ({
  ...
  alternates: {
    canonical: "https://nutab.ca/services/app-software-development",
  },
  openGraph: {
    title: "Custom App & Software Development Calgary | Mobile, Web & Enterprise Solutions | NuTab Digital",
    description:
    ...
    url: "https://nutab.ca/services/app-software-development",
...
const pricingLdJson = {
  ...
  itemListElement: devPackages.map((p, i) => {
    ...
    return {
      ...
      url: `https://nutab.ca/services/app-software-development#${p.id}`,
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 3, name: "Custom App & Software Development", item: "https://nutab.ca/services/app-software-development" }
            ]
          }),
        }}
      />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Service",
            "@id": "https://nutab.ca/services/app-software-development#service",
